...
var IconNoteSolid = function (_Component) {
  _inherits(IconNoteSolid, _Component);

  function IconNoteSolid() {
    _classCallCheck(this, IconNoteSolid);

    return _possibleConstructorReturn(this, (IconNoteSolid.__proto__ || Object.getPrototypeOf(IconNoteSolid)).apply(this, arguments));
  }

  _createClass(IconNoteSolid, [{
    key: 'render',
