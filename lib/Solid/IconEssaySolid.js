...
var IconEssaySolid = function (_Component) {
  _inherits(IconEssaySolid, _Component);

  function IconEssaySolid() {
    _classCallCheck(this, IconEssaySolid);

    return _possibleConstructorReturn(this, (IconEssaySolid.__proto__ || Object.getPrototypeOf(IconEssaySolid)).apply(this, arguments));
  }

  _createClass(IconEssaySolid, [{
    key: 'render',
