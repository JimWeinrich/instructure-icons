...
var IconAdminLine = function (_Component) {
  _inherits(IconAdminLine, _Component);

  function IconAdminLine() {
    _classCallCheck(this, IconAdminLine);

    return _possibleConstructorReturn(this, (IconAdminLine.__proto__ || Object.getPrototypeOf(IconAdminLine)).apply(this, arguments));
  }

  _createClass(IconAdminLine, [{
    key: 'render',
