...
var IconBoldLine = function (_Component) {
  _inherits(IconBoldLine, _Component);

  function IconBoldLine() {
    _classCallCheck(this, IconBoldLine);

    return _possibleConstructorReturn(this, (IconBoldLine.__proto__ || Object.getPrototypeOf(IconBoldLine)).apply(this, arguments));
  }

  _createClass(IconBoldLine, [{
    key: 'render',
