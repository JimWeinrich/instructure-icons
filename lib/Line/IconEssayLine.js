...
var IconEssayLine = function (_Component) {
  _inherits(IconEssayLine, _Component);

  function IconEssayLine() {
    _classCallCheck(this, IconEssayLine);

    return _possibleConstructorReturn(this, (IconEssayLine.__proto__ || Object.getPrototypeOf(IconEssayLine)).apply(this, arguments));
  }

  _createClass(IconEssayLine, [{
    key: 'render',
