...
var IconNoteLine = function (_Component) {
  _inherits(IconNoteLine, _Component);

  function IconNoteLine() {
    _classCallCheck(this, IconNoteLine);

    return _possibleConstructorReturn(this, (IconNoteLine.__proto__ || Object.getPrototypeOf(IconNoteLine)).apply(this, arguments));
  }
